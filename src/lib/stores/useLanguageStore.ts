...
export const traduccionesUI: Record<string, Record<string, string>> = {
  ...
  CA: {
    ...
    cookiesAnaliticasDesc: "Ajuden a millorar la eina mesurant l'ús de manera anònima.",
    ...
    cookiesBannerPreferenciaDesc:
      'Permeten recordar informació perquè accedeixis al servei amb determinades característiques (idioma).',
    ...
    techGemini: 'Intel·ligència Artificial',
  ...
  GL: {
    ...
    configTitulo: 'Configuración',
    configIdioma: 'Idioma',
    configIdiomaDesc: 'Seleccione o idioma da interface. O cambio aplicarase inmediatamente.',
    ...
    cookiesBannerTexto:
      'Empregamos cookies propias e de terceiros para mellorar a túa experiencia e analizar o uso da web. Podes aceptar todas as cookies, refusalas ou configurar as túas preferencias.',
    cookiesBannerConfigurar: 'Configurar',
    ...
    cajaSugerencias: 'Caixa de suxestións',
    cajaSugerenciasSubtitulo: 'Envíanos a túa opinión ou informa de erros',
    cajaPlaceholder: 'Que mellorarías?',
    cajaGracias: 'Grazas!',
    cajaMinimizar: 'Minimizar',
    cajaEnviar: 'Enviar',
    cajaEnviando: 'Enviando...',
    ...
    techTailwind: 'Estilos',
    techSupabase: 'Base de datos',
    techGemini: 'Intelixencia Artificial',
  ...
  EU: {
    ...
    cookiesBannerAceptar: 'Guztiak onartu',
    ...
    atribucionArasaacTexto:
      'Erabilitako piktograma sinboloak Aragoiko Gobernuarenak dira eta Sergio Palaok sortu ditu ARASAAC-erako (http://www.arasaac.org), Creative Commons BY-NC-SA lizentziapean banatuta.',
    deslindeAragon:
      'Aragoiko Gobernua ez da arduradun material hauek hirugarrenek egiten duten erabileraren gainetik.',
    tecnologias: 'Erabilitako Teknologiak',
    techNextjs: 'Web framework',
    techTypescript: 'Idazketa motako hizkuntza',
    techTailwind: 'Estiloak',
    techSupabase: 'Datu basea',
    techGemini: 'Adimen Artifiziala',
    ...
    licencia: 'Lizentzia:',
    propiedad: 'Jabetza:',
    gobiernoAragon: 'Aragoiko Gobernua (Espainia)',
    ...
    formPlaceholderTitulo: 'Beldur zuen dragoia',
    formTematica: 'Gaiak',
  ...
  FR: {
    ...
    sobreHistoriaParrafo2:
      "Il n'existait pas d'endroit qui lui permettrait de créer une histoire de zéro et de la transformer, instantanément, en ressource visuelle prête à imprimer. En tant que développeuse, j'ai su que la technologie devait combler ce vide.",
    sobreHistoriaParrafo3:
    ...
    configAvisoLegal: 'Mentions légales',
    ...
    techGemini: 'Intelligence Artificielle',
  ...
  DE: {
    ...
    accederApp: 'ERSTELLE EINE GESCHICHTE',
    ...
    techGemini: 'Künstliche Intelligenz',
  ...
  IT: {
    ...
    techTailwind: 'Stili',
    techSupabase: 'Database',
    techGemini: 'Intelligenza Artificiale',
